...
plt.title('Absolute Errors for Problem B (h=0.2)')
plt.yscale('log') 
plt.xlabel('t')
...
plt.title('Absolute Errors for Problem B (h=0.1)')
plt.yscale('log') # 
plt.xlabel('t')
plt.ylabel('Absolute Error')
plt.legend()
...
plt.title('Absolute Errors for Problem B (h=0.05)')
plt.yscale('log')
plt.xlabel('t')
plt.ylabel('Absolute Error')
plt.legend()
...
# ==========================================
# Global Convergence Plot (Log-Log) for Problem B
# ==========================================
...
plt.title('Global Convergence: All Methods vs Step Size (Problem B)')
